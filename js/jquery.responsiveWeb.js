...
;(function ( $, window, document, undefined ) {
	...
	function decideResolution() {
		...
		if (w >= 1200) { cC = ' widescreen desktop' + ' '; }
		else if (w >= 980 && w <= 1199) { cC = ' desktop bootstrap-default tablet tablet-landscape '; }
		else if (w >= 768 && w <= 979) { cC = ' tablet tablet-portrait '; }
		else if (w >= 481 && w <= 767) { cC = ' phone-landscape tablet '; }
		else if (w < 480 && w >= 320) { cC = ' phone-portrait phone '; }
		else { cC = 'dumb-phone '; }
